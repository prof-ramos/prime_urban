  ...
  return (
    ...
    >
      <div className="relative min-h-[360px] overflow-hidden rounded-lg border border-white/[12%] bg-[var(--navy-950)]">
        ...
        <div className="absolute left-[35%] top-[24%] h-[58%] w-[22%] rotate-[-12deg] rounded-full border border-[var(--bronze-300)]/50" />
        ...
        {mappedNeighborhoods.map((neighborhood) => (
          ...
          >
            <span className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full bg-secondary text-[var(--navy-950)] shadow-[0_12px_30px_rgba(0,0,0,0.35)] transition-transform group-hover:scale-110">
